       ...
       <div className="container mx-auto px-4">
        <section className="py-8 px-4 text-center">
            <div className="max-w-auto mx-auto">
                ...
                <Link href="/"><span className="mt-6 bg-lightb/75 hover:bg-lightb text-white font-light py-4 px-6 rounded-full inline-block uppercase shadow-md cursor-pointer"> Back To Home </span></Link>
            </div>
        </section>
    </div>
    </>
