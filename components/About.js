...
const About = () => {
  return (
    <>
    <div className="grid grid-cols-1 lg:grid-cols-2 overflow-hidden dark:bg-darko/10 w-[100vw] overflow-x-hidden">
        ...
        <h3 className='absolute rotate-90 left-0 ml-[-1.5rem] mt-[15vh] font-medium sm:text-base text-sm text-darko dark:text-lightb 2xl:text-2xl'>Designer <span className='font-bold'>'s</span></h3>
        </div>
        {/* about us content */}
        <div className="text-black dark:text-black 2xl:space-y-3 lg:my-auto">
          ...
          <div className="flex justify-center space-x-4 2xl:text-3xl mt-2 mb-4">
            ...
            <Link href="www.github.com"><svg viewBox="0 0 496 512" className='fill-black hover:border-b-4 hover:border-b-darko dark:hover:border-b-4 dark:hover:border-b-lightb w-6 h-6 cursor-pointer sm:ml-2'>
            ...
            <Link href="www.linkedin.com"><svg viewBox="0 0 448 512" className='fill-black hover:border-b-4 hover:border-b-darko dark:hover:border-b-4 dark:hover:border-b-lightb w-6 h-6 cursor-pointer'>
                <path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/>
            </svg>
            </Link>
            <Link href="www.instagram.com"><svg viewBox="0 0 448 512" className='fill-black hover:border-b-4 hover:border-b-darko dark:hover:border-b-4 dark:hover:border-b-lightb w-6 h-6 cursor-pointer'>
