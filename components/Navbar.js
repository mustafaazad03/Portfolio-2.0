		...
		<nav className="dark:bg-black bg-[#fff]">
			<div className="flex justify-evenly space-x-[40%] md:space-x-[60%] lg:space-x-32 xl:space-x-64">
				...
				>
					<Link href="/">
						<Image
							src={dark ? "/logodark.png" : "/logolight.png"}
				...
				>
					{navlink.map((value, idx) => {
						return (
							<li
								className="dark:text-light hover:dark:text-darko hover:border-b-[3px] hover:text-lightb focus-within:border-lightb  dark:hover:border-darko focus-within:border-b-4 dark:focus-within:border-darko"
								key={idx}
							>
